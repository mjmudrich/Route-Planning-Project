...
{    
    ...
    // User defined starting and ending coordinates to define path.
    // Coordinates restricted to [100]
    ...
    // Create RoutePlanner object utilizing user inputed data and perform A* search.
